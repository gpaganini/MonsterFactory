#para adicionar um computador num controlador de dominio RODC, crie a conta do computador no AD, altere a senha com o ADSI edit (right click, change password)
...
#apos adicionar a maquina no dominio, abrir o ADSI Edit, abrir as propriedades do objeto e incluir os atributos no campo ServicePrincipalName (copiar de outra conta)
...
$ports = 53,88,135,389,445,464,636,3268,3269    # DNS, Kerberos, RPC Endpoint Mapper, LDAP, SMB, Kerberos Change/Set Password, LDAP-SSL, GC, GC-SSL, Custom RPC Static Port For NetLogon
