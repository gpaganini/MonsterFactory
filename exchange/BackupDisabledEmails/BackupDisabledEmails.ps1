$CSV = "C:\Users\giovani.paganini\powershellson\exchange\BackupDisabledEmails\desabilitados-14102020.csv" #caminho do arquivo csv que possui os UserPrincipalNames dos usuarios
